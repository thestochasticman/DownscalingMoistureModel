"""model8 held-out per-station series, from the cached LOSO predictions.

Reads data/model8_loso_predictions.csv; nothing re-calibrates here.

Run from repo root::  PYTHONPATH=. python handout/plot_model8_per_station.py
"""
...
FIG = REPO / "handout" / "figures" / "model8_per_station.png"
...
pred = pd.read_csv(REPO / "data" / "model8_loso_predictions.csv", parse_dates=["time"])
...
fig.suptitle(f"model8 (bucket + SLGA soil) leave-site-out prediction vs observation, "
